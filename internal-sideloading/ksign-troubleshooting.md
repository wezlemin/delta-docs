...
- If you open Roblox and it gives an update pop-up, join the Delta Discord server ([https://discord.com/invite/deltax](https://discord.com/invite/deltax)) and wait until the devs ping about an update for Delta. Once they ping, delete Delta (from App Library), download the new IPA, then import it in KSign/ESign and sign and install it.
...
- If you get an extraction error when using KSign, please ensure the IPA downloaded correctly (it should not be 0 bytes, it should be 100MB+). If you did download it correctly, go to KSign Settings > Archive & Extraction > Switch the extraction library. Afterwards, close the app and reopen it, then try to re-import.
...
- You can buy a certificate here ([https://muacert.com](https://muacert.com)).
> Other websites include [https://arcticsign.app/](https://arcticsign.app/), [https://ko-fi.com/rustsign](https://ko-fi.com/rustsign) and [https://wsfteam.xyz/](https://wsfteam.xyz/) (NOTE: MIGHT BE OUT OF STOCK). <br>
> This website also provides certificates: [https://flarestore.app/](https://flarestore.app/)
...
> To factory reset: [https://support.apple.com/en-gb/108931](https://support.apple.com/en-gb/108931)
