...
## Instructions
1. Download [this](https://github.com/wezlemin/delta-docs/raw/refs/heads/main/my-docs/docs/fixes/Workspace.zip) ZIP.
...
6. Open the Files app on your device.
7. Go to Browse > On My (Device) > Delta > Delta.
