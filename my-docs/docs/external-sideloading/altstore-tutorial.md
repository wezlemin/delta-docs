...
> If it does not appear, make sure your phone is unlocked and trusted by your computer. You may need to disconnect and reconnect your iDevice.
5. Enter your Apple ID (Email) and Password, then Enter.
...
> If it does not appear, make sure your phone is unlocked and trusted by your computer. You may need to disconnect and reconnect your iDevice.
6. Enter your Apple ID (Email) and Password, then Enter.

## Using AltStore
1. AltStore should have appeared on your iDevice. However, you might need to trust it first. Go to Settings > General > VPN & Device Management. Trust your Apple ID, then tap Trust again to confirm.
2. Open AltStore. If you are prompted to allow AltStore to find devices on local networks, click Allow. If you want, you can enable notifications.
